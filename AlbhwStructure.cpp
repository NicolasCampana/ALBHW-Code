...
void AlbhwStructure::setInstance(int cycT, std::vector<int> tTimes, int numT, int numPrec,
...
void AlbhwStructure::readFile(std::string file) {
    ...
    setInstance(cycT,auxtaskT, numT, numPrec, predecessors, sucessors, closure, tTypes , twTimes, wCosts);
