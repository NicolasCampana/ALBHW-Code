...
void Graph::calculateCriticalPath(int ubStations){
    ...
    newP = new int*[newVertices];
    tmin = new int[newVertices];
    tmax = new int[newVertices];
    int i,j;
    
    for(i = 0; i < newVertices; ++i) {
        tmin[i] = 0;
        newP[i] = new int[newVertices];
    }
