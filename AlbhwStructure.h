...
class AlbhwStructure {
    public:
        ...
        //Constructors
        void setInstance(int cycT, std::vector<int> tTimes, int numT, std::vector<int>* predecessors, std::vector<int>* sucessors, int** closure, std::vector<int> tTypes , int** twTimes, std::vector<int> wCosts);
		~AlbhwStructure();
        AlbhwStructure();
		// Gets
		int getCyc();
